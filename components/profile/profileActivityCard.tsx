        ...
        return (
            <View style={{ margin: 15,marginBottom:30}}>
                <View style={style.activityCard}>
                    <Text style={style.activityHeader}>
                        All Time Activity
                    </Text>
                    <Text style={style.activityText}>
                        Last 7 Days: {this.props.last7dayActivity} Hours
                    </Text>
                    <Text style={style.activityText}>
                        Last 30 Days: {this.props.last30dayActivity} Hours
                    </Text>
                    <Text style={style.activityText}>
                        Total: {this.props.allActivityTime} Hours
                    </Text>
